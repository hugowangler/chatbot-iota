...
def preprocess_amazon_data():
    ...
    (
        ...
        training_labels,
        validation_labels,
    ) = train_test_split(  # split the data into training, validation, and test splits
    ...
    training_data = word_vectorizer.fit_transform(
        training_data
    ...
    validation_x_tensor = torch.from_numpy(np.array(validation_data)).type(
        torch.FloatTensor
    )
